...
package testdocker.createfiletestdb_0_1;
...
/**
 * Job: CreateFileTestDB Purpose: CreateFileTest in docker<br>
 * Description: CreateFileTest in docker <br>
 * @author user@talend.com
 * @version 6.1.0.20151029_1337
 * @status 
 */
public class CreateFileTestDB implements TalendJob {
	...
	public class ContextProperties extends java.util.Properties {
		...
		public void synchronizeContext() {
			...
			if (Conf_Path != null) {
				...
				this.setProperty("Conf_Path", Conf_Path.toString());

			}

			if (Folder_Out != null) {

				this.setProperty("Folder_Out", Folder_Out.toString());

			}

			if (NameFile_CreateFileTestDB != null) {

				this.setProperty("NameFile_CreateFileTestDB",
						NameFile_CreateFileTestDB.toString());

			}

			if (SMAR_MySql_AdditionalParams != null) {

				this.setProperty("SMAR_MySql_AdditionalParams",
						SMAR_MySql_AdditionalParams.toString());

			}

			if (SMAR_MySql_Database != null) {

				this.setProperty("SMAR_MySql_Database",
						SMAR_MySql_Database.toString());

			}

			if (SMAR_MySql_Login != null) {

				this.setProperty("SMAR_MySql_Login",
						SMAR_MySql_Login.toString());

			}

			if (SMAR_MySql_Password != null) {

				this.setProperty("SMAR_MySql_Password",
						SMAR_MySql_Password.toString());

			}

			if (SMAR_MySql_Port != null) {

				this.setProperty("SMAR_MySql_Port", SMAR_MySql_Port.toString());

			}

			if (SMAR_MySql_Server != null) {

				this.setProperty("SMAR_MySql_Server",
						SMAR_MySql_Server.toString());
		...
		public String NameFile_CreateFileTestDB;

		public String getNameFile_CreateFileTestDB() {
			return this.NameFile_CreateFileTestDB;
		}

		public String SMAR_MySql_AdditionalParams;

		public String getSMAR_MySql_AdditionalParams() {
			return this.SMAR_MySql_AdditionalParams;
		}

		public String SMAR_MySql_Database;

		public String getSMAR_MySql_Database() {
			return this.SMAR_MySql_Database;
		}

		public String SMAR_MySql_Login;

		public String getSMAR_MySql_Login() {
			return this.SMAR_MySql_Login;
		}

		public java.lang.String SMAR_MySql_Password;

		public java.lang.String getSMAR_MySql_Password() {
			return this.SMAR_MySql_Password;
		}

		public String SMAR_MySql_Port;

		public String getSMAR_MySql_Port() {
			return this.SMAR_MySql_Port;
		}

		public String SMAR_MySql_Server;

		public String getSMAR_MySql_Server() {
			return this.SMAR_MySql_Server;
		}
	}
	...
	private final String jobName = "CreateFileTestDB";
	private final String projectName = "TESTDOCKER";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					CreateFileTestDB.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(CreateFileTestDB.this, new Object[] { e,
	...
	public static class row_Implicit_Context_RegexStruct implements
		...
		final static byte[] commonByteArrayLock_TESTDOCKER_CreateFileTestDB = new byte[0];
		static byte[] commonByteArray_TESTDOCKER_CreateFileTestDB = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TESTDOCKER_CreateFileTestDB.length) {
					if (length < 1024
							&& commonByteArray_TESTDOCKER_CreateFileTestDB.length == 0) {
						commonByteArray_TESTDOCKER_CreateFileTestDB = new byte[1024];
					} else {
						commonByteArray_TESTDOCKER_CreateFileTestDB = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TESTDOCKER_CreateFileTestDB, 0,
						length);
				strReturn = new String(
						commonByteArray_TESTDOCKER_CreateFileTestDB, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TESTDOCKER_CreateFileTestDB) {
	...
	public void Implicit_Context_RegexProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				 ...
				 */
				context.Conf_Path/** End field Implicit_Context_Regex:FILENAME */
				;
				...
				while (inImplicit_Context_Regex.readRecord()) {
					...
					try {
						...
						if (valueImplicit_Context_Regex[0] != null
							...
							row_Implicit_Context_Regex.key = null;
						}
						...
						if (valueImplicit_Context_Regex[1] != null
							...
							row_Implicit_Context_Regex.value = null;
						}
						...
						if (tmp_key_Implicit_Context_Context != null) {
							try {
								if (key_Implicit_Context_Context != null
									...
									context.Conf_Path = value_Implicit_Context_Context;
								}

								if (key_Implicit_Context_Context != null
										&& "Folder_Out"
												.equals(key_Implicit_Context_Context)) {
									context.Folder_Out = value_Implicit_Context_Context;
								}

								if (key_Implicit_Context_Context != null
										&& "NameFile_CreateFileTestDB"
												.equals(key_Implicit_Context_Context)) {
									context.NameFile_CreateFileTestDB = value_Implicit_Context_Context;
								}

								if (key_Implicit_Context_Context != null
										&& "SMAR_MySql_AdditionalParams"
												.equals(key_Implicit_Context_Context)) {
									context.SMAR_MySql_AdditionalParams = value_Implicit_Context_Context;
								}

								if (key_Implicit_Context_Context != null
										&& "SMAR_MySql_Database"
												.equals(key_Implicit_Context_Context)) {
									context.SMAR_MySql_Database = value_Implicit_Context_Context;
								}

								if (key_Implicit_Context_Context != null
										&& "SMAR_MySql_Login"
												.equals(key_Implicit_Context_Context)) {
									context.SMAR_MySql_Login = value_Implicit_Context_Context;
								}

								if (key_Implicit_Context_Context != null
										&& "SMAR_MySql_Password"
												.equals(key_Implicit_Context_Context)) {
									context.SMAR_MySql_Password = value_Implicit_Context_Context;
								}

								if (key_Implicit_Context_Context != null
										&& "SMAR_MySql_Port"
												.equals(key_Implicit_Context_Context)) {
									context.SMAR_MySql_Port = value_Implicit_Context_Context;
								}

								if (key_Implicit_Context_Context != null
										&& "SMAR_MySql_Server"
												.equals(key_Implicit_Context_Context)) {
									context.SMAR_MySql_Server = value_Implicit_Context_Context;
								}
	...
	public static class Out_MysqlStruct implements
			routines.system.IPersistableRow<Out_MysqlStruct> {
		final static byte[] commonByteArrayLock_TESTDOCKER_CreateFileTestDB = new byte[0];
		static byte[] commonByteArray_TESTDOCKER_CreateFileTestDB = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(Out_MysqlStruct other) {
	...
	public void tMysqlInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				Out_MysqlStruct Out_Mysql = new Out_MysqlStruct();
				...
				java.io.File file_tFileOutputJSON_2 = new java.io.File(
						context.Folder_Out + context.NameFile_CreateFileTestDB);
				...
				java.io.PrintWriter outtFileOutputJSON_2 = new java.io.PrintWriter(
						new java.io.BufferedWriter(new java.io.FileWriter(
								context.Folder_Out
										+ context.NameFile_CreateFileTestDB)));
				...
				Out_MysqlStruct Out_Mysql_tmp = new Out_MysqlStruct();
				// ###############################
				...
				String dbUser_tMysqlInput_1 = context.SMAR_MySql_Login;

				final String decryptedPassword_tMysqlInput_1 = context.SMAR_MySql_Password;

				String dbPwd_tMysqlInput_1 = decryptedPassword_tMysqlInput_1;

				String url_tMysqlInput_1 = "jdbc:mysql://"
						+ context.SMAR_MySql_Server + ":"
						+ context.SMAR_MySql_Port + "/"
						+ context.SMAR_MySql_Database + "?"
						+ context.SMAR_MySql_AdditionalParams;
				...
				try {
					...
					while (rs_tMysqlInput_1.next()) {
						...
						{ // start of Var scope
							...
							// # Output table : 'Out_Mysql'
							Out_Mysql_tmp.id = Numeric.random(0, 100);
							Out_Mysql_tmp.name = row1.Name;
							Out_Mysql = Out_Mysql_tmp;
							// ###############################
						...
						if (Out_Mysql != null) {
							...
							if (Out_Mysql.name != null) {

								jsonRowtFileOutputJSON_2.put("name",
										Out_Mysql.name);

							} else {
								jsonRowtFileOutputJSON_2.put("name", null);
							}
	...
	public static void main(String[] args) {
		final CreateFileTestDB CreateFileTestDBClass = new CreateFileTestDB();

		int exitCode = CreateFileTestDBClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = CreateFileTestDB.class
					.getClassLoader().getResourceAsStream(
							"testdocker/createfiletestdb_0_1/contexts/"
			...
			context.Conf_Path = (String) context.getProperty("Conf_Path");
			context.Folder_Out = (String) context.getProperty("Folder_Out");
			context.NameFile_CreateFileTestDB = (String) context
					.getProperty("NameFile_CreateFileTestDB");
			context.SMAR_MySql_AdditionalParams = (String) context
					.getProperty("SMAR_MySql_AdditionalParams");
			context.SMAR_MySql_Database = (String) context
					.getProperty("SMAR_MySql_Database");
			context.SMAR_MySql_Login = (String) context
					.getProperty("SMAR_MySql_Login");
			String pwd_SMAR_MySql_Password_value = context
					.getProperty("SMAR_MySql_Password");
			context.SMAR_MySql_Password = null;
			if (pwd_SMAR_MySql_Password_value != null) {
				if (context_param.containsKey("SMAR_MySql_Password")) {// no
																		// need
																		// to
																		// decrypt
																		// if it
																		...
																		// job
																		// runtime
					context.SMAR_MySql_Password = pwd_SMAR_MySql_Password_value;
				} else if (!pwd_SMAR_MySql_Password_value.isEmpty()) {
					try {
						context.SMAR_MySql_Password = routines.system.PasswordEncryptUtil
								.decryptPassword(pwd_SMAR_MySql_Password_value);
						context.put("SMAR_MySql_Password",
								context.SMAR_MySql_Password);
					} catch (java.lang.RuntimeException e) {
						// do nothing
					}
				}
			}
			context.SMAR_MySql_Port = (String) context
					.getProperty("SMAR_MySql_Port");
			context.SMAR_MySql_Server = (String) context
					.getProperty("SMAR_MySql_Server");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("Conf_Path")) {
				context.Conf_Path = (String) parentContextMap.get("Conf_Path");
			}
			if (parentContextMap.containsKey("Folder_Out")) {
				context.Folder_Out = (String) parentContextMap
						.get("Folder_Out");
			}
			if (parentContextMap.containsKey("NameFile_CreateFileTestDB")) {
				context.NameFile_CreateFileTestDB = (String) parentContextMap
						.get("NameFile_CreateFileTestDB");
			}
			if (parentContextMap.containsKey("SMAR_MySql_AdditionalParams")) {
				context.SMAR_MySql_AdditionalParams = (String) parentContextMap
						.get("SMAR_MySql_AdditionalParams");
			}
			if (parentContextMap.containsKey("SMAR_MySql_Database")) {
				context.SMAR_MySql_Database = (String) parentContextMap
						.get("SMAR_MySql_Database");
			}
			if (parentContextMap.containsKey("SMAR_MySql_Login")) {
				context.SMAR_MySql_Login = (String) parentContextMap
						.get("SMAR_MySql_Login");
			}
			if (parentContextMap.containsKey("SMAR_MySql_Password")) {
				context.SMAR_MySql_Password = (java.lang.String) parentContextMap
						.get("SMAR_MySql_Password");
			}
			if (parentContextMap.containsKey("SMAR_MySql_Port")) {
				context.SMAR_MySql_Port = (String) parentContextMap
						.get("SMAR_MySql_Port");
			}
			if (parentContextMap.containsKey("SMAR_MySql_Server")) {
				context.SMAR_MySql_Server = (String) parentContextMap
						.get("SMAR_MySql_Server");
			}
		}
		...
		parametersToEncrypt.add("SMAR_MySql_Password");
		// Resume: jobStart
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : CreateFileTestDB");
		}
...
/************************************************************************************************
 * 62272 characters generated by Talend Open Studio for ESB on the 17 décembre
 * 2015 09:38:21 CET
 ************************************************************************************************/
